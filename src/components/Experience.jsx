...
import { Calendar, Briefcase, Code, Github, Layers, Eye } from "lucide-react"
            ...
            <Card className="experience-card card-hover border border-gray-100 dark:border-gray-700 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm overflow-hidden">
              <CardContent className="p-6 pl-8">
                ...
                <div className="flex flex-wrap gap-4 mb-4">
                  ...
                  <Link href={`/proyectos/${job.id}`} passHref>
                    <Button
                      variant="outline"
                      size="sm"
                      className="gap-2 border-accent-500 text-accent-600 hover:bg-accent-50 dark:border-accent-400 dark:text-accent-400 dark:hover:bg-accent-900/20"
                    >
                      <Eye size={16} />
                      Ver proyecto
                    </Button>
